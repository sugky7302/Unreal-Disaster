...
local ej = {
    ...
    Item2S = function(item)
        return ascii.encode(cj.GetItemTypeId(item))
    end,
    U2Id = function(u)
        return cj.GetUnitTypeId(u)
    end,
    U2S = function(u)
        return ascii.encode(cj.GetUnitTypeId(u))
    end,
    O2Id = function(order)
    ...
    tip = function(player, msg)
        msg = type(msg) == 'string' and msg or table.concat(msg)
        cj.DisplayTimedTextToPlayer(player, 0., 0., 6., msg)
    end,
